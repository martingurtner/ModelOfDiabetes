...
text text text
\begin{equation}
	h(t) = -\frac{1}{\gamma}\left[   A(\lambda_1 + \delta)e^{\lambda_1\,t} + B(\lambda_2 + \delta)e^{\lambda_2\,t}  \right] = 0.211\,g_0 \left(e^{\lambda_1\,t} - e^{\lambda_2\,t} \right)
\end{equation}
...
\begin{figure}[h!t!]
	...
	\,
	\subfigure[Insuline concentration]{
