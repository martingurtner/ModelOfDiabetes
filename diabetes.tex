...
Another, less general, model of insulin-glucose interaction by Bellomo et al. is briefly examined.
...
We can reduce the linearised model from eq.~\ref{eqLinearized} to a 2\textsuperscript{nd} order differential equation by differentiating the first equation and substituting $\dot h$ with the right hand side of the second equation:
...
\todo[inline]{Napsat podminky pri kterych byl simulovany prubehy v grafech}
